/**
 * FileToSafe object {file, unsafeRegexArray, limit}
...
FileToSafe.prototype.getUnsafeRegexInFileSync = function() {
  let data = '';
  if (this.file) {
    try {
...
FileToSafe.prototype.getUnsafeRegexInFile = function(callback) {
...
FileToSafe.prototype.getUnsafeRegexInData = function(data, position = -1) {
  let regex = null;
  let r1 = /[^//](\/.+\/[gimy]{0,4})[.; ]/g;
